...
const ProductDetails = () => {
  ...
  const handleBuy = () => {
    if (userQuantity < minimumQuantity) {
              ...
              <div className="flex flex-col gap-2 items-center">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="btn rounded-2xl px-5 bg-primary text-white"
                  >
                    <CircleMinus size={35} />
                  </button>
                  <p className="text-2xl bg-black text-white w-10 text-center rounded-full">
                    {userQuantity}
                  </p>
                  <button
                    onClick={() => setUserQuantity(userQuantity + 1)}
                    className="btn px-5 rounded-2xl bg-primary text-white"
                  >
                    <CirclePlus size={35} />
                  </button>
                </div>
