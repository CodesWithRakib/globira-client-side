        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
            <img
              ...
              alt={productName}
              className="w-full h-96 object-contain p-4 bg-gray-50 dark:bg-gray-900"
              loading="lazy"
            />
          </div>
            ...
            {displayImages.slice(0, 4).map((img, index) => (
              ...
              >
                <img
                  ...
                  className="w-full h-20 object-contain bg-gray-50 dark:bg-gray-900"
                  loading="lazy"
                />
              </motion.div>
            ))}
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="mt-3 flex items-center gap-2">
                  {mainQuantity > 0 ? (
                    <span className="flex items-center gap-1 bg-green-100 text-green-800 text-sm px-3 py-1 rounded-full dark:bg-green-900/30 dark:text-green-300">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      In stock ({mainQuantity} available)
                    </span>
                  ) : (
                    <span className="flex items-center gap-1 bg-red-100 text-red-800 text-sm px-3 py-1 rounded-full dark:bg-red-900/30 dark:text-red-300">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-300 flex items-center">
                      <Clock className="w-5 h-5 mr-1 text-blue-600 dark:text-blue-500" />
                      Lead time:
                    </span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-300 flex items-center">
                      <Package className="w-5 h-5 mr-1 text-blue-600 dark:text-blue-500" />
                      Minimum order:
                    </span>
                    <span className="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            <h3 className="flex items-center text-xl font-semibold text-gray-900 dark:text-white mb-4">
              <ListChecks className="w-5 h-5 text-blue-600 dark:text-blue-500 mr-2" />
              Specifications
            </h3>
            <div className="space-y-4">
              <div className="flex">
                <span className="w-40 text-gray-600 dark:text-gray-400 flex items-center">
                  <Tag className="w-4 h-4 text-blue-600 dark:text-blue-500 mr-2" />
                  Brand
                </span>
                <span className="font-medium text-gray-800 dark:text-gray-200">
                  {brandName}
              ...
              <div className="flex">
                <span className="w-40 text-gray-600 dark:text-gray-400 flex items-center">
                  <Folder className="w-4 h-4 text-blue-600 dark:text-blue-500 mr-2" />
                  Category
                </span>
              ...
              <div className="flex">
                <span className="w-40 text-gray-600 dark:text-gray-400 flex items-center">
                  <Box className="w-4 h-4 text-blue-600 dark:text-blue-500 mr-2" />
                  Material
                </span>
                <span className="font-medium text-gray-800 dark:text-gray-200">
              ...
              <div className="flex">
                <span className="w-40 text-gray-600 dark:text-gray-400 flex items-center">
                  <Ruler className="w-4 h-4 text-blue-600 dark:text-blue-500 mr-2" />
                  Dimensions
                </span>
                <span className="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="form-control">
                  ...
                  <input
                    className="input input-bordered w-full bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-100"
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="btn btn-xs btn-circle btn-ghost text-gray-600 hover:text-blue-600 dark:hover:text-blue-500"
                    ...
                    <input
                      type="number"
                      className="w-12 text-center border rounded font-medium py-1 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100"
                      value={userQuantity}
                      min={1}
                      max={mainQuantity}
                      onChange={(e) => {
            ...
            <div className="modal-action">
              <form method="dialog" className="w-full space-y-3">
                <button
                  onClick={handleBuy}
                  className="btn bg-blue-600 hover:bg-blue-700 border-0 w-full py-3 text-lg font-bold text-white"
                  disabled={mainQuantity <= 0}
                >
                  <Check className="w-6 h-6 mr-2" />
                  Confirm Order
                </button>
                <button className="btn btn-ghost w-full text-gray-700 dark:text-gray-300">
                  Cancel
                </button>
              </form>
            </div>
